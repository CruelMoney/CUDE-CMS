    ...
    render() {
        ...
        return (this.props.editMode
            ? <div
                    ...
                    this
                        .props
                        .registerEdits(this.props.entityID, {
...
class ConnectedText extends React.Component {
        ...
        if (this.context.staticContext && this.props.haveFetched) {
            ...
            if (!found) {
                this
                    ...
                    .staticContext
                    .promises
                    .push(fetch(Config.PUBLIC_URL + '/api/texts', {
                        method: 'POST',
                        credentials: 'include',
    ...
    render() {
        const dbText = Array.isArray(this.props.data) && this
            .props
            .data
            .find(t => t.key === this.props.dbKey) || {}
        const content = dbText
            ? dbText.content
            : null
        return (<EditableText
            {...this.props}
...
export default fetcher(editor(ConnectedText, "/api/texts"), "/api/texts")
